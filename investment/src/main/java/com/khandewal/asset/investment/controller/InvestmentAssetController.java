package com.khandewal.asset.investment.controller;
...
import com.khandewal.asset.investment.service.InvestmentAssetService;
...
public class InvestmentAssetController {
	...
	public ResponseEntity<Optional<InvestmentAsset>> getInvestmentAssetByNumber(
			@PathVariable String assetnumber) {

		return new ResponseEntity<Optional<InvestmentAsset>>(
	...
	/*
	 * @GetMapping(value =
	 * "/getAssetByNumberOrIfscCodeOrSortCodeOrNameAndType/{assetNumber}/{ifscCode}/{sortCode}/{assetName}/{assetType}")
	 * public ResponseEntity<Collection<InvestmentAsset>>
